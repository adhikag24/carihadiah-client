...
<div class="container px-5 py-3 mx-auto" style="min-height: 89vh;">
    ...
    <div class="container my-10 flex sm:hidden justify-center">
        <div class="w-full bg-gray-200 rounded-full">
            <div id="progress-bar" class="bg-orange-400 text-xs font-medium text-white text-center p-0.5 leading-none rounded-full" style="width: 0%">0%</div>
        </div>
    </div>
    ...
    <div id="multistep-form">
        ...
        <div id="step-3" class="step-content hidden">
            ...
            <h3 id="age-val" class="text-center text-2xl font-bold mb-4 text-black">20 Tahun</h2>
